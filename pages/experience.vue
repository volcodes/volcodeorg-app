    ...
    <div id="timeline" class="container">
      <article>
        ...
        <div class="card">
          ...
          <span>Sdui Gmbh</span>
          <ul>
            <li>One Encrypted Chat App with React</li>
            <li>One School Platform with Vue</li>
            <li>One iOs Mobile App Instance</li>
          </ul>
          <div class="technologies">
            ...
            <span>
              <MdiIcon icon="mdiElectronFramework" />
              <span>Electron</span>
            </span>
            <span>
